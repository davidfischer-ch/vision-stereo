...
# set top entity name
set project_name VisionStereo
set top_name     VisionStereo
...
# J3-3		L5		sclk			busC_SCL
# J13-4		K5		sda				busC_SDA
...
cmp add_assignment $top_name "" busC_SCL LOCATION "Pin_L5"
cmp add_assignment $top_name "" busC_SDA LOCATION "Pin_K5"
...
# J1-2 		R10		mclk			outP_MCLK
# J1-18		T6		nReset			outP_NRESET

# J1-17		R6		sclk			busP_SCL
# J1-16		R7		sda				busP_SDA

# J1-15 	P7		vsync 			inP_SYNC[1]
# J1-14 	N7		hsync 			inP_SYNC[0]

# J1-11:4 	N8:R9	d[7:0] 			inP_DATA[7:0]
